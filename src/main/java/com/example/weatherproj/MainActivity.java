    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View v) {
                  ...
                  try {
                       url = new URL("https://api.openweathermap.org/data/2.5/find?lat=" + s1 + "&lon=" + s2 + "&cnt=3&units=imperial&appid=5a48c6340fb9da15c0a5971004d73e61");
        ...
        public class Weather extends AsyncTask<URL, Void, Void> {
            protected Void doInBackground(URL... urls) {
                ...
                try {
                    ...
                    x = rootObject.getJSONArray("list").getJSONObject(0).getJSONObject("main").getString("temp");
                    subName1=rootObject.getJSONArray("list").getJSONObject(0).getString("name");
                    //subDesc1= rootObject.getJSONArray("list").getJSONObject(0).getJSONArray("weather").getJSONObject(0).getString("description");
                    subDesc1 = rootObject.getJSONArray("list").getJSONObject(0).getJSONArray("weather").getJSONObject(0).getString("main");
                    subDT = rootObject.getJSONArray("list").getJSONObject(0).getString("dt");

                    Log.d("AAAA",rootObject.toString());


                    y = rootObject.getJSONArray("list").getJSONObject(1).getJSONObject("main").getString("temp");
                    subName2=rootObject.getJSONArray("list").getJSONObject(1).getString("name");
                    subDesc2 = rootObject.getJSONArray("list").getJSONObject(1).getJSONArray("weather").getJSONObject(0).getString("main");


                    z = rootObject.getJSONArray("list").getJSONObject(2).getJSONObject("main").getString("temp");
                    subName3=rootObject.getJSONArray("list").getJSONObject(2).getString("name");
                    subDesc3 = rootObject.getJSONArray("list").getJSONObject(2).getJSONArray("weather").getJSONObject(0).getString("main");
